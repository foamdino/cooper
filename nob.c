...
int main(int argc, char **argv)
{
    ...
    nob_cmd_append(&cc_cmd, "-o", BUILD_FOLDER"libcooper.so", 
        SRC_FOLDER"arena.c", SRC_FOLDER"arena_str.c", SRC_FOLDER"log.c", SRC_FOLDER"cache.c", SRC_FOLDER"config.c", SRC_FOLDER"shared_mem.c", SRC_FOLDER"cooper.c", SRC_FOLDER"cli.c", "-pthread", "-lrt");
    ...
    nob_cmd_append(&test_cmd, "cc", "-Wall", "-Wextra", "-fPIC", JAVA_INC, LINUX_INC, "-I.", "-Isrc", "-g", "-o", BUILD_FOLDER"test_cooper", 
        SRC_FOLDER"arena.c", SRC_FOLDER"arena_str.c", SRC_FOLDER"log.c", SRC_FOLDER"cache.c", SRC_FOLDER"config.c", SRC_FOLDER"shared_mem.c", SRC_FOLDER"cooper.c", SRC_FOLDER"test_cooper.c", "-pthread", "-lrt");
