...
static time_t
get_file_mod_time(const char *path)
{
	struct stat st;
	if (stat(path, &st) == 0)
		return st.st_mtime;
...
static int
load_tui_functions(tui_loader_t *loader)
{
...
static int
load_tui_library(tui_loader_t *loader)
{
...
tui_loader_t *
tui_loader_init(const char *tui_library_path)
{
	if (!tui_library_path)
		return NULL;
...
void
tui_loader_cleanup(tui_loader_t *loader)
{
	if (!loader)
		return;
...
int
tui_loader_check_and_reload(tui_loader_t *loader)
{
	if (!loader)
		return -1;
...
void
tui_loader_draw(tui_loader_t *loader, const tui_context_t *ctx)
{
...
char *
tui_loader_get_version(tui_loader_t *loader)
{
...
int
tui_loader_is_loaded(tui_loader_t *loader)
{
